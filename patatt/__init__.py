...
def _run_command(cmdargs: list[str], stdin: Optional[bytes] = None, env: Optional[dict[str, str]] = None) -> Tuple[int, bytes, bytes]:
...
def set_bin_paths(config: Optional[dict]) -> Tuple[str, str]:
